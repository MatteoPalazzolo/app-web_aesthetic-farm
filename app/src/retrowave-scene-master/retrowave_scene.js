...
const HARDCODED_PATH = "./retrowave-scene-master/";
...
import sun_svg from "./scenery/sun.svg";
import cityFar_svg from "./scenery/city_far.svg";
import cityClose_svg from "./scenery/city_close.svg";

import invisible_png from "./skybox/1024/invisible.png"
import nx_png from "./skybox/1024/nx.png"
import nz_png from "./skybox/1024/nz.png"
import px_png from "./skybox/1024/px.png"
import py_png from "./skybox/1024/py.png"
...
export var RetrowaveScene = function (scenePath) {
    ...
    this.svgFiles = [
        [sun_svg, 0, 40, -500, 0.11, "sun"],
        [cityFar_svg, 0, 15, -450, 0.4, "cityFar"],
        [cityClose_svg, 0, 28, -300, 0.2, "cityClose"],
    ];
    ...
    this.skybox = [
        ...
        nx_png, // X-
        py_png, // Y+
        invisible_png, // Y- (out of camera FoV here)
        invisible_png, // Z+ (out of camera FoV here)
        nz_png, // Z-
    ];
